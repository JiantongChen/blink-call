...
![修改眨眼序列](https://cdn.jsdelivr.net/gh/JiantongChen/blink-call@main/user_manual/docs/images/blink-pattern-settings.jpg)
...
![添加或删除动作](https://cdn.jsdelivr.net/gh/JiantongChen/blink-call@main/user_manual/docs/images/blink-pattern-settings.gif)
