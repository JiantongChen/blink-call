...
class CameraPage:
    def __init__(self, content_stack):
        ...
        self.fallback_switch_row = QWidget()
        fallback_switch_layout = QHBoxLayout(self.fallback_switch_row)
        fallback_switch_layout.setContentsMargins(0, 0, 0, 0)
        fallback_switch_layout.setSpacing(16)
        self.fallback_switch_label = QLabel("Enable fallback camera")
        self.fallback_on_radio = QRadioButton("On")
        self.fallback_off_radio = QRadioButton("Off")
        fallback_switch_layout.addWidget(self.fallback_switch_label)
        fallback_switch_layout.addStretch()
        fallback_switch_layout.addWidget(self.fallback_on_radio)
        fallback_switch_layout.addWidget(self.fallback_off_radio)
        layout.addWidget(self.fallback_switch_row)

        self.fallback_id_row = QWidget()
        fallback_id_layout = QHBoxLayout(self.fallback_id_row)
        fallback_id_layout.setContentsMargins(0, 0, 0, 0)
        fallback_id_layout.setSpacing(16)
        self.fallback_id_label = QLabel("Fallback camera ID")
        self.fallback_id_spin = NoWheelSpinBox()
        self.fallback_id_spin.setMinimum(0)
        self.fallback_id_spin.setMaximum(20)
        self.fallback_id_spin.setFixedWidth(90)
        fallback_id_layout.addWidget(self.fallback_id_label)
        fallback_id_layout.addStretch()
        fallback_id_layout.addWidget(self.fallback_id_spin)
        layout.addWidget(self.fallback_id_row)
