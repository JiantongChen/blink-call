...
class HomeView(QWidget):
    ...
    def __init__(self, vm, nav):
        ...
        i18n = self.TEXTS.get(self.vm.ui_language, self.TEXTS["zh"])
        ...
        self.vm.language_changed.connect(self._apply_language)
    ...
    def _set_service_mode(self, active):
        self.exit_btn.setVisible(bool(active))
        self._position_exit_btn()
